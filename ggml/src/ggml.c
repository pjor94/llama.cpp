...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_0_ROT] = {
        .type_name                = "q4_0_rot",
        .blck_size                = QK4_0_ROT,
        .type_size                = sizeof(block_q4_0_rot),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_0_rot,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_0_rot_ref,
    },
    [GGML_TYPE_Q2_K] = {
        .type_name                = "q2_K",
        .blck_size                = QK_K,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q4_0_ROT: result = quantize_q4_0_rot(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
